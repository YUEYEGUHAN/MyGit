...
<script type='text/javascript'  src='${pageContext.request.contextPath}/busicomps/interfaceapi/content/prplisclaimorganizationinfo/prplisclaimorganizationinfoList.js?version=${resourceVersion}'></script>
		...
		<div class="panel panel-default fixed no-footer fullheight">
			<div class="panel-heading clearfix">
				...
				<div class="panel-toolbar pull-right">
					<div class="form-inline">
						...
						data-url="/rest/interfaceapi/PrpLisClaimOrganizationInfoService/query?queryName=queryList&filterQuery=true&queryType=page&id="
						onKeyUp="DataTablesUtil.event.search(this, event, 'PrpLisClaimOrganizationInfogrid')"/>
						<button class="btn btn-info " type="button"
							data-url="/interfaceapi/PrpLisClaimOrganizationInfoService/add"
							data-id="PrpLisClaimOrganizationInfogrid" onclick="add(this,'form','xxxxx')">
						    新增
						</button>
						<button class="btn btn-danger form-control" type="button"
							data-url="/rest/interfaceapi/PrpLisClaimOrganizationInfoService?multi=true"
							onclick="del(this,'table')"
							data-id="PrpLisClaimOrganizationInfogrid">
							删除
						</button>
					</div>
				</div>
			...
			<div class="panel-content">
				<table cellpadding="0" cellspacing="0" border="0"
					...
					id="PrpLisClaimOrganizationInfogrid" data-page-length="25" data-selection="multiple"
					data-pk-column="id"
					data-url="/rest/interfaceapi/PrpLisClaimOrganizationInfoService/query?queryName=queryList&filterQuery=true&queryType=page">
					<thead>
						<tr>
							...
							<th data-column="comcode"   data-orderable="false" class="text-center"
								width="80px" data-link='/interfaceapi/PrpLisClaimOrganizationInfoService/id/' data-link-params='id' >
							       COMCODE      
							 </th> 
...
<script type="text/javascript">
    DataTablesUtil.loadAjaxTable("PrpLisClaimOrganizationInfogrid");
</script>
