...
<script type='text/javascript'  src='${pageContext.request.contextPath}/busicomps/interfaceapi/content/prplissmslogs/prplissmslogsList.js?version=${resourceVersion}'></script>
		...
		<div class="panel panel-default fixed no-footer fullheight">
			<div class="panel-heading clearfix">
				...
				<div class="panel-toolbar pull-right">
					<div class="form-inline">
						...
						data-url="/rest/interfaceapi/PrpLisSmsLogsService/query?queryName=queryList&filterQuery=true&queryType=page&id="
						onKeyUp="DataTablesUtil.event.search(this, event, 'PrpLisSmsLogsgrid')"/>
						<button class="btn btn-info " type="button"
							data-url="/interfaceapi/PrpLisSmsLogsService/add"
							data-id="PrpLisSmsLogsgrid" onclick="add(this,'form','xxxxx')">
						    新增
						</button>
						<button class="btn btn-danger form-control" type="button"
							data-url="/rest/interfaceapi/PrpLisSmsLogsService?multi=true"
							onclick="del(this,'table')"
							data-id="PrpLisSmsLogsgrid">
							删除
						</button>
					</div>
				</div>
			...
			<div class="panel-content">
				<table cellpadding="0" cellspacing="0" border="0"
					...
					id="PrpLisSmsLogsgrid" data-page-length="25" data-selection="multiple"
					data-pk-column="id"
					data-url="/rest/interfaceapi/PrpLisSmsLogsService/query?queryName=queryList&filterQuery=true&queryType=page">
					<thead>
						<tr>
							...
							<th data-column="comcode"   data-orderable="false" class="text-center"
								width="80px" data-link='/interfaceapi/PrpLisSmsLogsService/id/' data-link-params='id' >
							       组织机构编码      
							 </th> 
...
<script type="text/javascript">
    DataTablesUtil.loadAjaxTable("PrpLisSmsLogsgrid");
</script>
