...
<script type='text/javascript'  src='${pageContext.request.contextPath}/busicomps/interfaceapi/content/prplisearlywarnconfig/prplisearlywarnconfigList.js?version=${resourceVersion}'></script>
		...
		<div class="panel panel-default fixed no-footer fullheight">
			<div class="panel-heading clearfix">
				...
				<div class="panel-toolbar pull-right">
					<div class="form-inline">
						...
						data-url="/rest/interfaceapi/PrpLisEarlyWarnConfigService/query?queryName=queryList&filterQuery=true&queryType=page&id="
						onKeyUp="DataTablesUtil.event.search(this, event, 'PrpLisEarlyWarnConfiggrid')"/>
						<button class="btn btn-info " type="button"
							data-url="/interfaceapi/PrpLisEarlyWarnConfigService/add"
							data-id="PrpLisEarlyWarnConfiggrid" onclick="add(this,'form','xxxxx')">
						    新增
						</button>
						<button class="btn btn-danger form-control" type="button"
							data-url="/rest/interfaceapi/PrpLisEarlyWarnConfigService?multi=true"
							onclick="del(this,'table')"
							data-id="PrpLisEarlyWarnConfiggrid">
							删除
						</button>
					</div>
				</div>
			...
			<div class="panel-content">
				<table cellpadding="0" cellspacing="0" border="0"
					...
					id="PrpLisEarlyWarnConfiggrid" data-page-length="25" data-selection="multiple"
					data-pk-column="id"
					data-url="/rest/interfaceapi/PrpLisEarlyWarnConfigService/query?queryName=queryList&filterQuery=true&queryType=page">
					<thead>
						<tr>
							...
							<th data-column="organcode"   data-orderable="false" class="text-center"
								width="80px" data-link='/interfaceapi/PrpLisEarlyWarnConfigService/id/' data-link-params='id' >
							       机构编码      
							 </th> 
							...
							<th data-column="level"   data-orderable="false" class="text-center"
								width="80px">
							       机构级别      
							 </th> 
...
<script type="text/javascript">
    DataTablesUtil.loadAjaxTable("PrpLisEarlyWarnConfiggrid");
</script>
