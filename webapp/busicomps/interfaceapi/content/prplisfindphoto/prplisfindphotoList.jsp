...
<script type='text/javascript'  src='${pageContext.request.contextPath}/busicomps/interfaceapi/content/prplisfindphoto/prplisfindphotoList.js?version=${resourceVersion}'></script>
		...
		<div class="panel panel-default fixed no-footer fullheight">
			<div class="panel-heading clearfix">
				...
				<div class="panel-toolbar pull-right">
					<div class="form-inline">
						...
						data-url="/rest/interfaceapi/PrpLisFindPhotoService/query?queryName=queryList&filterQuery=true&queryType=page&="
						onKeyUp="DataTablesUtil.event.search(this, event, 'PrpLisFindPhotogrid')"/>
						<button class="btn btn-info " type="button"
							data-url="/interfaceapi/PrpLisFindPhotoService/add"
							data-id="PrpLisFindPhotogrid" onclick="add(this,'form','xxxxx')">
						    新增
						</button>
						<button class="btn btn-danger form-control" type="button"
							data-url="/rest/interfaceapi/PrpLisFindPhotoService?multi=true"
							onclick="del(this,'table')"
							data-id="PrpLisFindPhotogrid">
							删除
						</button>
					</div>
				</div>
			...
			<div class="panel-content">
				<table cellpadding="0" cellspacing="0" border="0"
					...
					id="PrpLisFindPhotogrid" data-page-length="25" data-selection="multiple"
					...
					<thead>
						<tr>
							...
							<th data-column="photo"   data-orderable="false" class="text-center"
								width="80px" data-link='/interfaceapi/PrpLisFindPhotoService/id/' data-link-params='psncode' >
							       PHOTO      
							 </th> 
						</tr>
					</thead>
...
<script type="text/javascript">
    DataTablesUtil.loadAjaxTable("PrpLisFindPhotogrid");
</script>
