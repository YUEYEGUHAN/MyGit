...
!function (a) {
    ...
    k.prototype = {
        ...
        fill: function () {
            ...
            if (!isNaN(g) && !isNaN(h)) {
                this.picker.find(".datepicker-days .datepicker-switch").text(r.formatDate(f, o, this.o.language)), this.picker.find("tfoot .today").text(m).css("display", this.o.todayBtn === true || "linked" === this.o.todayBtn ? "table-cell" : "none"), this.picker.find("tfoot .clear").text(n).css("display", this.o.clearBtn === true ? "table-cell" : "none"), this.picker.find("thead .datepicker-title").text(this.o.title).css("display", "string" == typeof this.o.title && "" !== this.o.title ? "table-cell" : "none"), this.updateNavArrows(), this.fillMonths();
        ...
        updateNavArrows: function () { //上一年和下一年的计算
            if (this._allow_update) {
                ...
                switch (this.viewMode) {
                    ...
                    case 2:
                        j *= 10;
                    case 1:
                        // a = Math.floor(d / j) * j <= f, b = Math.floor(d / j) * j + j >= h; //之前的不正确的
                        a = Math.floor(d / j) * j <= f, b = Math.floor(d / j) * j >= h; //修改后，正确的了
                }
                // console.log(a,b,c,f,g,h,i,e,d);
